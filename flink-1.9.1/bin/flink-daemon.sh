...
log_setting=("-Dlog.file=${log}" "-Dlog.dir=${FLINK_LOG_DIR}" "-Dlog4j.configuration=file:${FLINK_CONF_DIR}/log4j.properties" "-Dlogback.configurationFile=file:${FLINK_CONF_DIR}/logback.xml")
