...
export declare class NzSelectComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy, AfterContentInit {
    ...
    constructor(renderer: Renderer2, nzSelectService: NzSelectService, cdr: ChangeDetectorRef, focusMonitor: FocusMonitor, elementRef: ElementRef, noAnimation?: NzNoAnimationDirective | undefined);
