...
public class FlinkKafkaConsumer010<T> extends FlinkKafkaConsumer09<T> {
	 ...
	 */
	public FlinkKafkaConsumer010(String topic, DeserializationSchema<T> valueDeserializer, Properties props, TracingFramework tf) {
	...
	protected AbstractFetcher<T, ?> createFetcher(
		...
		Kafka010Fetcher<T> fetcher = new Kafka010Fetcher<>(
			sourceContext,
